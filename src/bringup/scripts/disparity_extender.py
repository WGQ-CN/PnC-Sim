...
speed_param = rospy.get_param('~speed_param', 2.8) # 小车行驶速度
...
if __name__ == '__main__': 
  try:
    ...
    drive_pub = rospy.Publisher('/ackermann_cmd_mux/output', AckermannDriveStamped, queue_size=1)
    rospy.spin()
